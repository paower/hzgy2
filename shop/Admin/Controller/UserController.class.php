...
class UserController extends AdminController
{
     ...
     public function index()
    {
        ...
        $page=$p->show();
        $data_list     = $table
            ->field('a.userid,a.username,a.is_jihuo,a.earning,a.userlevel,a.idcard,a.email,a.yinbi,a.account,a.mobile,a.reg_date,a.status,a.pid,b.cangku_num,b.fengmi_num,b.sv,b.sc,b.dt_jifen')
            ->where($map)
            ->order($order_str)
            ->select();
